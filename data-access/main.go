...
func addAlbum(alb Album) (int64, error) {
	// Use the RETURNING clause to get the id of the inserted album
...
func main() {
	...
	cfg := "user=postgres password=Adilek2003alimgozha dbname=recordings host=localhost sslmode=disable"
